...
#
#     PHX_SERVER=true bin/mail_sense start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :mail_sense, MailSenseWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :mail_sense, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :mail_sense, MailSense.Mailer,
