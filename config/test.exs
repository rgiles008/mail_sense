...
config :mail_sense, MailSense.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "mail_sense_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :mail_sense, MailSenseWeb.Endpoint,
  ...
  secret_key_base: "mjPSPtbJAQuxvUMAoaHpaM/SKotHfTt/9wje7Y4hu/TBSHL2ZQy0O5jzszRvHq9Y",
  server: false

# In test we don't send emails
config :mail_sense, MailSense.Mailer, adapter: Swoosh.Adapters.Test
